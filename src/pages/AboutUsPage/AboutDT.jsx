      ...
      <main className="main about">
        <div>
          <div
            ...
            style={{
              background:
                '50%/cover #D4E1EA url("https://assets.vogue.com/photos/661ee57d4c8934da79402dce/master/w_1600,c_limit/pn_-107.jpg")',
            }}
          >
          ...
          <div className="about-section">
            <div className="container">
              <h2 className="subtitle">CHÍNH SÁCH ĐỔI TRẢ</h2>
              <p>
                Khách hàng có thể đổi trả sản phẩm trong vòng 7 ngày kể từ ngày
                nhận hàng nếu sản phẩm gặp lỗi kỹ thuật hoặc không đúng với mô
                tả. Sản phẩm phải còn nguyên vẹn, đầy đủ phụ kiện và bao bì ban
                đầu. Chúng tôi sẽ kiểm tra và xác nhận tình trạng sản phẩm trước
                khi tiến hành đổi trả hoặc hoàn tiền.
              </p>
