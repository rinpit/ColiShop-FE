      ...
      <main className="main about">
        <div>
          <div
            ...
            style={{
              background:
                '50%/cover #D4E1EA url("https://assets.vogue.com/photos/662167825d9312d26f82cdd0/master/w_1600,c_limit/IMG_2982.jpeg")',
            }}
          >
          ...
          <div className="about-section">
            <div className="container">
              <h2 className="subtitle">VỀ CHÚNG MÌNH</h2>
              <p>
                Coli - Nơi thời trang tái sinh Một chiếc váy mất 2 ngày từ gia
                công đến khi lên sản phẩm và có thể còn mất tới 200 năm để tự
                phân hủy. Vậy nhưng tới 80% quần áo hiện đang bị "bỏ rơi" hoặc
                bỏ đi khi vẫn còn có thể sử dụng tốt?
              </p>
              <p>
                Một cô gái văn phòng năng động, một nàng thơ yêu sự giản đơn hay
                một bà mẹ bỉm sữa mỗi ngày vật lộn trong bộn bề cuộc sống thì
                đều giống nhau. Chúng ta đều phải tiêu tốn nhiều vào những món
                đồ thời trang dù biết chắc sẽ chỉ dùng một vài lần. Biết điều đó
                là lãng phí nhưng phải công nhận, thật khó lòng làm khác được vì
                thời trang luôn là vậy, luôn cần sự đổi mới và phát triển.
              </p>
              <p>
                Những trang phục không dùng nữa chồng chất trong nhà không chỉ
                khiến bạn thấy tiếc nuối vì đã phải tiêu tốn không hề ít, mà còn
                làm không gian của bạn trở nên bức bối. Có bao giờ bạn nghĩ
                rằng, những món đồ đó sẽ có cơ hội trải nghiệm một cuộc đời thứ
                hai, và bạn cũng có cơ hội tiếp theo để chọn những món đồ khác
                hợp ý hơn chưa?
              </p>
              <p>
                Bởi những điều tích cực kia, bạn có tự hỏi khởi nguồn của Coli
                được tạo ra từ đâu? Coli - Kho ký gửi thời trang tuần hoàn với
                hàng ngàn sản phẩm đến và đi mỗi tháng được sinh ra từ sự bất
                lực của một người đàn ông khi nhìn thấy tủ quần áo đầy ắp của vợ
                mình. Điều anh ấy muốn không chỉ người phụ nữ của mình, hơn cả
                là nữ giới nói chung đều sẽ có được trải nghiệm tuyệt vời khi
                mua sắm mà không phải lo lắng đến sức chứa có hạn của những
                chiếc tủ hay tác hại mà ngành thời trang nhanh đang mang lại cho
                môi trường.
              </p>
              <p>
                Tại Coli, có thể bạn không tìm thấy sự sang chảnh, hào nhoáng
                của những cửa hàng thời trang nhanh đang thay đổi mẫu mã hàng
                ngày hàng giờ. Tại đây chỉ có sự giản dị, chân thành và chuyên
                nghiệp chính là điều mà Coli luôn hướng đến. Chúng mình không
                coi công việc mỗi ngày đơn giản chỉ là nhận và gửi đi những món
                đồ không được dùng tới. Bởi lẽ Coli còn làm được nhiều hơn thế -
                nơi này sẽ trao câu chuyện mới cho các sản phẩm xinh xắn, gửi đi
                những thông điệp môi trường nhân văn về ký gửi cũng như việc tái
                sử dụng kho thời trang tuần hoàn, việc này cũng là giúp các cô
                gái như chúng mình tiết kiệm và hoàn lại thật xứng đáng và ngày
                càng xinh đẹp hơn.
              </p>
              <p
                className="lead"
