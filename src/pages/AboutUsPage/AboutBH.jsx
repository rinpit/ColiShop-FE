      ...
      <main className="main about">
        <div>
          <div
            ...
            style={{
              background:
                '50%/cover #D4E1EA url("https://assets.vogue.com/photos/65b9666c0e9d3844d31fca37/master/w_1920,c_limit/voguecollection_icons_WEB_1%20copy.png")',
            }}
          >
            <div className="container">
              <h1 style={{ color: "#1E3636" }}>
                <span>ABOUT US</span>
          ...
          <div className="about-section">
            <div className="container">
              <h2 className="subtitle">CHÍNH SÁCH BẢO HÀNH</h2>
              <p>
                Chúng tôi cam kết bảo hành các sản phẩm quần áo và phụ kiện theo
                quy định của từng nhà sản xuất và từng loại sản phẩm. Khách hàng
                cần giữ lại hóa đơn mua hàng và phiếu bảo hành (nếu có) để được
                hưởng các quyền lợi bảo hành.
              </p>
