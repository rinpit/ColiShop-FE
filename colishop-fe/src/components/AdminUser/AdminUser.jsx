...
import { DeleteOutline, EditOutlined, SearchOutlined, UploadOutlined } from '@mui/icons-material';
...
const AdminUser = () => {
    ...
    const renderAction = () => {
        return (
            <div>
                <DeleteOutline style={{ fontSize: '30px', cursor: 'pointer' }} onClick={() => setIsModalOpenDelete(true)} />
                <EditOutlined style={{ fontSize: '30px', marginLeft: '10px', cursor: 'pointer' }} onClick={handleDetailsUser} />
            </div>
        )
    }
    // search, sort, filter ==========================================================================
        ...
        <div>
            ...
            <ModalComponent forceRender title="Xoá người dùng" open={isModalOpenDelete} onCancel={handleCancelDelete} onOk={handleDeleteUser}>
                <Loading isLoading={isLoadingDeleted}>
                    <div>Bạn muốn xoá tài khoản này không?</div>
                </Loading>
            </ModalComponent>
        </div>
    )
