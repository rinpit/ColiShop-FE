  ...
  return (
    <div className="page-wrapper">
      <section className="intro-section mb-3">
        {/* <div
          className="home-slider slide-animate owl-carousel owl-theme"
          data-owl-options="{
               'nav': false,
               'responsive': {
                   '1440': {
        ...
        >
          <div className="home-slide home-slide-1 banner">
            <img
              className="slide-bg"
              src="assets/images/banners/slide1.png"
              alt="slider image"
              width={1200}
              height={400}
            />
          ...
          <div className="home-slide home-slide-2 banner">
            <img
              className="slide-bg"
              src="assets/images/banners/slide2.png"
              alt="slider image"
              width={1200}
              height={400}
            />
            <div className="banner-layer banner-layer-middle banner-layer-right w-100">
              <div className="container-fluid">
                <div
                  className="col-6 offset-6 appear-animate"
          ...
          <div className="row mb-2">
            <div className="col-md-8 col-lg-6">
              ...
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-1.jpg"
                    alt="banner"
                    width={580}
                    height={374}
                  />
            ...
            <div className="col-md-4 col-lg-3">
              ...
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-2.jpg"
                    alt="banner"
                    width={280}
                    height={374}
                  />
            ...
            <div className="col-md-6 col-lg-3">
              <div
                className="banner banner3 mb-2 appear-animate"
                data-animation-name="fadeIn"
                data-animation-delay={200}
              ...
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-3.jpg"
                    alt="banner"
                    width={280}
                    height={374}
                  />
                ...
                <div className="banner-layer d-flex flex-column align-items-center justify-content-between">
                  <h2 className="font-weight-bold ls-n-25 text-center text-uppercase">
                    Mother &amp; Daughter
                  </h2>
                  <a href="demo23-shop.html" className="btn btn-link">
            ...
            <div className="col-md-6 col-lg-3">
              <div
                className="banner banner4 mb-2 appear-animate"
                data-animation-name="fadeIn"
                data-animation-delay={200}
              ...
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-4.jpg"
                    alt="banner"
                    width={560}
                    height={374}
                  />
            ...
            <div className="col-md-4 col-lg-3">
              <div
                className="banner banner5 mb-2 appear-animate"
                data-animation-name="fadeIn"
                data-animation-delay={200}
                style={{ backgroundColor: "#f5ecef" }}
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-5.jpg"
                    alt="banner"
                    width={280}
                    height={374}
                  />
            ...
            <div className="col-md-8 col-lg-6">
              <div
                className="banner banner6 mb-2 appear-animate"
                data-animation-name="fadeIn"
                data-animation-delay={200}
              ...
              >
                <figure>
                  <img
                    src="assets/images/demoes/demo23/banners/banner-6.jpg"
                    alt="banner"
                    width={280}
                    height={374}
                  />
              ...
              <div className="product-default inner-quickview inner-icon">
                <figure>
                  <a href="demo23-product.html">
                    <img
                      src="assets/images/demoes/demo23/products/product-1.jpg"
                      width={217}
                      height={217}
                      alt="product"
                    />
                    <img
                      src="assets/images/demoes/demo23/products/product-7.jpg"
                      width={217}
                      height={217}
                      alt="product"
                    />
            ...
            <div className="col-6 col-md-4 col-xl-3">
              <div className="product-default inner-quickview inner-icon">
                <figure>
                  <a href="demo23-product.html">
                    <img
                      src="assets/images/demoes/demo23/products/product-2.jpg"
                      width={217}
                      height={217}
                      alt="product"
                    />
            ...
            <div className="col-6 col-md-4 col-xl-3">
              <div className="product-default inner-quickview inner-icon">
                <figure>
                  <a href="demo23-product.html">
                    <img
                      src="assets/images/demoes/demo23/products/product-3.jpg"
                      width={217}
                      height={217}
                      alt="product"
                    />
      ...
      <div className="cats-banner-section mb-3">
        <div className="row m-0 no-gutters">
          ...
          <div className="col-lg-9">
            <div
              className="categories-slider owl-carousel owl-theme"
              data-owl-options="{
                  'margin': 0,
                  'nav': false,
                  'items': 1,
            ...
            >
              <div
                ...
                style={{ backgroundColor: "#d8dfe1" }}
              >
                <a href="demo23-shop.html">
                  <figure>
                    <img
                      src="assets/images/demoes/demo23/products/cats/cat-1.jpg"
                      alt="cat banner"
                      width={500}
                      height={400}
                    />
              ...
              >
                <a href="demo23-shop.html">
                  <figure>
                    <img
                      src="assets/images/demoes/demo23/products/cats/cat-2.jpg"
                      alt="cat banner"
                      width={500}
                      height={400}
                    />
              ...
              <div
                className="product-category"
                style={{ backgroundColor: "#ead7d5" }}
              >
                <a href="demo23-shop.html">
                  <figure>
                    <img
                      src="assets/images/demoes/demo23/products/cats/cat-3.jpg"
                      alt="cat banner"
                      width={500}
                      height={400}
                    />
      ...
      {/* More Product */}
      <div
        className="products-container appear-animate"
        data-animation-name="fadeIn"
        data-animation-delay={200}
      >
        <div className="container">
