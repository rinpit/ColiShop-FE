      ...
      <main className="main about">
        <div>
          ...
          <div className="about-section">
            <div className="container">
              <h2 className="subtitle">ĐẶT HÀNG</h2>
              <p>
                Khách hàng có thể đặt hàng trực tiếp tại cửa hàng hoặc qua
                website của chúng tôi. Khi đặt hàng trực tuyến, vui lòng điền
                đầy đủ thông tin cá nhân và sản phẩm cần mua để chúng tôi xác
                nhận đơn hàng nhanh chóng.
              </p>
              <h2 className="subtitle">THANH TOÁN</h2>
              <p>
                Chúng tôi chấp nhận nhiều phương thức thanh toán bao gồm tiền
                mặt, chuyển khoản ngân hàng và các ví điện tử phổ biến như Momo,
                ZaloPay. Đối với các đơn hàng lớn hoặc đặc biệt, chúng tôi có hỗ
                trợ thanh toán trả góp không lãi suất.
              </p>
              <p className="lead">
