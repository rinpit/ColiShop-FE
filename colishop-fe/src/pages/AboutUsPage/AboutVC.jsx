      ...
      <main className="main about">
        <div>
          <div
            ...
            style={{
              background:
                '50%/cover #D4E1EA url("https://strapi-bus-eng-prod.s3.amazonaws.com/about_f5a8665262.jpg")',
            }}
          >
          ...
          <div className="about-section">
            <div className="container">
              <h2 className="subtitle">VẬN CHUYỂN NỘI THÀNH</h2>
              <p>
                Miễn phí vận chuyển trong khu vực nội thành Đà Nẵng cho các đơn
                hàng trên một mức giá trị nhất định. Thời gian giao hàng trong
                nội thành từ 1-2 ngày làm việc.
              </p>
              <h2 className="subtitle">VẬN CHUYỂN NGOẠI THÀNH</h2>
              <p>
                Với các đơn hàng ở ngoài khu vực nội thành, chúng tôi hợp tác
                với các dịch vụ vận chuyển uy tín để giao hàng tận nơi. Chi phí
                vận chuyển sẽ được tính dựa trên khoảng cách và trọng lượng của
                sản phẩm.
              </p>
              <p className="lead">
