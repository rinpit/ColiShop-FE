            ...
            <main className="main">
                ...
                <nav aria-label="breadcrumb" className="breadcrumb-nav">
                    <div className="container">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item"><a href="demo23-shop.html">Shop</a></li>
                            <li className="breadcrumb-item"><a href="demo23-shop.html">Dresses</a></li>
                            <li className="breadcrumb-item active" aria-current="page">Jasambac</li>
                        </ol>
                    </div>
                </nav>
                ...
                <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-5 col-md-6 product-single-gallery">
                                <div className="product-slider-container">
                                    ...
                                    <div className="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                        <div className="product-item">
                                            <img className="product-single-image" src="assets/images/demoes/demo23/products/zoom/product-0.jpg" 
                                ...
                                <div className="prod-thumbnail owl-dots">
                                    <div className="owl-dot">
                                        <img src="assets/images/demoes/demo23/products/zoom/product-0.jpg" width={110} height={110} alt="product-thumbnail" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-7 col-md-6 product-single-details">
                                ...
                                <div className="product-nav">
                                        ...
                                        <a href="#">
                                            ...
                                            <span className="product-popup">
                                                <span className="box-content">
                                                    <img alt="product" width={150} height={150} src="assets/images/demoes/demo23/products/product-5.jpg" style={{ paddingTop: '0px' }} />
                                    ...
                                    <div className="product-next">
                                        <a href="#">
                                            ...
                                            <span className="product-popup">
                                                <span className="box-content">
                                                    <img alt="product" width={150} height={150} src="assets/images/demoes/demo23/products/product-0.jpg" style={{ paddingTop: '0px' }} />
                                                    <span>jasambac</span>
                                                </span>
                                            </span>
                                        </a>
                                ...
                                <div className="product-desc">
                                    <p>
                                        Material unknown, 3/4 sleeve, v-neck, a-line silhouette, solid, embroidered detail, maroon, burgundy, knee length
                                    </p>
                                </div>
                                {/* End .product-desc */}
                    ...
                    <div className="products-section pt-0">
                        ...
                        <div className="products-slider 5col owl-carousel owl-theme dots-top dots-small" data-owl-options="{
                      'dots': true
                  }">
